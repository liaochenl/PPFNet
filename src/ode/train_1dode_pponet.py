...
if __name__ == "__main__":
    ...
    if pre:
        ...
        opt1 = torch.optim.Adam(net.parameters(), lr=1e-4, weight_decay=1e-6)
    ...
    model.cuda()
    # define the optimizer
    opt2 = torch.optim.Adam(model.parameters(), lr=3e-4, weight_decay=1e-6)
    lrs = torch.optim.lr_scheduler.StepLR(opt2, step_size=2000, gamma=0.8)
    ...
    print('Test Done!')
    torch.save(model.state_dict(), 'PPONet_ODE.pth')
    print('Model saved!')
